...
export const Contact = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 py-8 px-4">
      <div className="w-full max-w-3xl">
        <Card className="bg-white border border-gray-300 rounded-lg shadow-2xl p-6 transform transition-transform hover:scale-105 hover:shadow-xl duration-500 ease-in-out">
          ...
          <CardContent className="space-y-6">
            <div className="flex justify-center mb-6">
              <Button
                ...
                onClick={() => {
                  window.open("https://github.com/Ayushjodd/Xemen");
                }}
              >
              ...
              <div className="flex flex-col items-center bg-gray-50 p-4 rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out">
                ...
                <div className="flex flex-col items-center space-y-2">
                  <Button
                    className="flex items-center bg-gradient-to-r from-gray-800 to-gray-600 text-white py-2 px-4 rounded-lg hover:from-gray-700 hover:to-gray-500 transition duration-300 ease-in-out transform hover:scale-105"
                    onClick={() => {
                      window.open("https://github.com/Ayushjodd");
                    }}
                  >
                    <FaGithub className="mr-2 text-xl" />
                    Github Profile
